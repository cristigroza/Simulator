...
class Client:
    ...
    def run(self):
        while True:
            ...
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;32700;32700;1')
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;32700;32700;1')
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;32700;32700;1')
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;0;0;1')
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;10000;10000;1')
            self.read_sensors()
            self.send_and_receive('DcMotorPwmTimeCtrAll;30000;10000;1')
            self.read_sensors()
