...
class x80_SonarSensor(SonarSensor):

     def __init__(self,pose,robot):
         # values copied from SimIAm
         x,y,fi = pose
         SonarSensor.__init__(self, pose, robot, (0.05, 2.54, fi))
         self.sensor_undetected_obstacle_color = 0x66380474
...
class x80(QuickBot):
    ...
    def __init__(self, pose, color = 0xFFFFFF):
        ...
        self.base_plate_color = 0x66CC0000
        self.head_color = 0x66CC0000
        self.upper_plate_color = 0xF6CCCCCC
